...
type StaffSection = "staff" | "faqContributors";
...
export const sectionOrder: { id: StaffSection; label: string }[] = [
...
export const users: StaffUser[] = [
  ...
  },
  {
    name: "Xera",
    roles: ["admin", "developer"],
    tags: ["FAQ", "Launcher", "Liberator", "Loader"],
    github: "https://github.com/xeralin",
    avatar: "/media/pfp/xeralin.webp",
    sections: ["faqContributors", "staff"],
  },
  {
    name: "AKrisz2",
    roles: ["moderator", "developer"],
    tags: ["R6S Downloader", "Liberator"],
