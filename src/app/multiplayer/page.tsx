...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: (
      <ol>
        <li>
          <strong>Check your game version</strong> — Both players must download
      ...
      <Prose>
        <ol>
          ...
          <OnLinux>
            ...
            <li>
              Open the Launcher Settings, select the downloaded{" "}
              <code>.exe</code> under <strong>Radmin VPN</strong>, and press{" "}
              <strong>Run</strong>
            </li>
          </OnLinux>
          <li>
